...
import { schemaComposer, TContext } from './schemaComposer';
...
type DroidT = any;
export const DroidTC: ObjectTypeComposer<DroidT, TContext> =
  CharacterDTC.discriminator<DroidT>(DroidModel);

type PersonT = any;
export const PersonTC: ObjectTypeComposer<PersonT, TContext> =
  CharacterDTC.discriminator<PersonT>(PersonModel);
